...
4. **Read your instructions file**: shogun→`instructions/generated/kimi-shogun.md`, karo→`instructions/generated/kimi-karo.md`, ashigaru→`instructions/generated/kimi-ashigaru.md`, gunshi→`instructions/generated/kimi-gunshi.md`, gunshi2→Codex auto-loads `instructions/codex-gunshi.md` via AGENTS.md. **NEVER SKIP** — even if a conversation summary exists. Summaries do NOT preserve persona, speech style, or forbidden actions.
...
## /clear Recovery (ashigaru/gunshi/gunshi2 only)
