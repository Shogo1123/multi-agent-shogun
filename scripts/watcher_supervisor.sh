...
while true; do
    ...
    start_watcher_if_missing "ashigaru4" "multiagent:agents.2" "logs/inbox_watcher_ashigaru4.log"
    start_watcher_if_missing "gunshi" "multiagent:agents.3" "logs/inbox_watcher_gunshi.log"
    start_watcher_if_missing "ashigaru2" "multiagent:agents.4" "logs/inbox_watcher_ashigaru2.log"
    start_watcher_if_missing "ashigaru5" "multiagent:agents.5" "logs/inbox_watcher_ashigaru5.log"
    start_watcher_if_missing "gunshi2" "multiagent:agents.6" "logs/inbox_watcher_gunshi2.log"
    start_watcher_if_missing "ashigaru3" "multiagent:agents.7" "logs/inbox_watcher_ashigaru3.log"
    start_watcher_if_missing "ashigaru7" "multiagent:agents.8" "logs/inbox_watcher_ashigaru7.log"
    sleep 5
done
