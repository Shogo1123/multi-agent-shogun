...
hierarchy: "Lord (human) → Shogun → Karo → Ashigaru 1-5,7 / Gunshi (壱) / Gunshi2 (弐)"
...
files:
  ...
  gunshi_task: queue/tasks/gunshi.yaml  # Karo → Gunshi (壱) strategic assignments
  gunshi2_task: queue/tasks/gunshi2.yaml # Karo → Gunshi2 (弐) strategic assignments
  ...
  gunshi_report: queue/reports/gunshi_report.yaml  # Gunshi (壱) → Karo strategic reports
  gunshi2_report: queue/reports/gunshi2_report.yaml # Gunshi2 (弐) → Karo strategic reports
...
4. **Read your instructions file**: shogun→`instructions/generated/codex-shogun.md`, karo→`instructions/generated/codex-karo.md`, ashigaru→`instructions/generated/codex-ashigaru.md`, gunshi→`instructions/generated/codex-gunshi.md`, gunshi2→Codex auto-loads `instructions/codex-gunshi.md` via AGENTS.md. **NEVER SKIP** — even if a conversation summary exists. Summaries do NOT preserve persona, speech style, or forbidden actions.
...
## /new Recovery (ashigaru/gunshi/gunshi2 only)
